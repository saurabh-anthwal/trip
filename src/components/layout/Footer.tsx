          ...
          <div className="flex flex-wrap justify-between gap-8">
            ...
            <div className="flex-1 min-w-[250px] max-w-[306px]">
              ...
              <p className="mt-4 text-gray-600 leading-6">
                ...
                thrilling tour, vibrant city exploration ,or peaceful mountain
                retreat. Your perfect getaway awaits!
              </p>
              <div className="flex gap-4 mt-4 text-orange-500 text-xl">
                <a
                  href="https://www.facebook.com/share/18pCp6GoEa/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaFacebookF className="hover:text-orange-700 transition-colors duration-300" />
                </a>
                <a
                  href="https://www.instagram.com/triplanza/profilecard/?igsh=MWl5emhsN3Rqb3V4cQ=="
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaInstagram className="hover:text-orange-700 transition-colors duration-300" />
                </a>
                <a
                  href="https://www.linkedin.com/company/triplanza/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaLinkedinIn className="hover:text-orange-700 transition-colors duration-300" />
                </a>
                <a
                  href="https://www.youtube.com/@triplanza"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaYoutube className="hover:text-orange-700 transition-colors duration-300" />
                </a>
                <a
                  href="https://x.com/triplanza?t=pkJZ562ARLkSvTYbWM4P7Q&s=09"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaTwitter className="hover:text-orange-700 transition-colors duration-300" />
                </a>
                <a
                  href="https://www.threads.net/@triplanza"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaThreads className="hover:text-orange-700 transition-colors duration-300" />
                </a>
              </div>
            </div>
